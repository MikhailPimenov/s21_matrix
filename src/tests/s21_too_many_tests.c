...
#define IS_LESS_OR_EQUAL_ENABLED     // uncomment this line to enable tests for
                                     // s21_is_less_or_equal
#define IS_GREATER_ENABLED           // uncomment this line to enable tests for
                                     // s21_is_greater
#define IS_GREATER_OR_EQUAL_ENABLED  // uncomment this line to enable tests for
                                     // s21_is_greater_or_equal
#define IS_EQUAL_ENABLED             // uncomment this line to enable tests for
                                     // s21_is_equal
#define IS_NOT_EQUAL_ENABLED         // uncomment this line to enable tests for
                                     // s21_is_not_equal

#define FROM_INT_TO_DECIMAL_ENABLED  // uncomment this line to enable tests for
                                     // s21_from_int_to_decimal
#define FROM_FLOAT_TO_DECIMAL_ENABLED  // uncomment this line to enable tests
                                       // for s21_from_float_to_decimal
#define FROM_DECIMAL_TO_INT_ENABLED  // uncomment this line to enable tests for
                                     // s21_from_decimal_to_int
#define FROM_DECIMAL_TO_FLOAT_ENABLED  // uncomment this line to enable tests
                                       // for s21_from_decimal_to_float
...
#define TRUNCATE_ENABLED  // uncomment this line to enable tests for
                          // s21_truncate
